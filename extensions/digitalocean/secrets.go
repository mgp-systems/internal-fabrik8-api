...
func BootstrapDigitaloceanMgmtCluster(clientset kubernetes.Interface, cl *pkgtypes.Cluster, destinationGitopsRepoURL string) error {
	opts := providerConfig.BootstrapOptions{
		...
		CloudAuth:                cl.DigitaloceanAuth.Token,
